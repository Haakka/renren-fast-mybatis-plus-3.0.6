...
public class ScheduleJobServiceImpl extends ServiceImpl<ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
	...
	public PageUtils queryPage(Map<String, Object> params) {
		...
		QueryWrapper wrapper = Wrappers.query().like(StringUtils.isNotBlank(beanName),"bean_name", beanName);
		IPage<ScheduleJobEntity> page = this.page(new Query<ScheduleJobEntity>(params).getPage(),wrapper);
